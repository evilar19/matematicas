...
public class MayorMenorIgual extends Juegos implements Jugable{
	...
	public static void main(String[] args) {
		...
		System.out.println("���PORQUE LAS MATES NO TIENEN QUE SER ABURRIDAS!!!");
		...
		do {
			for (int i = 0; i < 10; i++) {
				...
				switch (opcion) {
				case 1:
					if (randomInt > randomInt2) pasa = true;
					else pasa = false;
					break;
				case 2:
				...
				if (pasa) { System.out.println("Enhorabuena tu respuesta es correcta pasas");
					aciertos++;
				} else {
			...
			if (aciertos >= 5) {
				if(nivel <= 2) {
					System.out.println("Enhorabuena ha pasado al siguiente nivel");
					nivel++;
				} else System.out.println("Has ganado!!!");
			} else System.out.println("Lo siento no ha pasado el juego ");
			...
			if(nivel <= 2){
				...
				System.out.println("Ha finalizado el juego, pajillero");
				salir = true;
			}
